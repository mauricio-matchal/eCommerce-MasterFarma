export function Filter() {
  return (
    <div className="flex flex-col px-4 py-7 bg-anil-950 rounded-[30px] text-white font-medium text-xl">
      ...
      <div>
        <input type="checkbox" className="mr-2" name="ate50" id="ate50" />
        <label htmlFor="ate50">Até R$50,00</label>
      </div>

      <div>
        <input type="checkbox" className="mr-2" name="ate100" id="ate100" />
        <label htmlFor="ate100">Até R$100,00</label>
      </div>

      <div>
        <input type="checkbox" className="mr-2" name="ate200" id="ate200" />
        <label htmlFor="ate200">Até R$200,00</label>
      </div>

      <div>
        <input type="checkbox" className="mr-2" name="acima200" id="acima200" />
      ...
      <div>
        <input type="checkbox" className="mr-2" name="preco" id="preco" />
